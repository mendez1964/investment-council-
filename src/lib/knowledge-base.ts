...
const KEYWORD_MAP: Record<string, string[]> = {
  ...
  'order block': ['technical/smart-money-concepts.md', 'technical/order-flow-microstructure.md'],
  ...
  'liquidity pool': ['technical/smart-money-concepts.md'],
  ...
  'cash secured put': ['options/options-income-wheel.md', 'options/options-strategies-complete.md'],
  ...
  'level 2': ['market-structure/market-structure-complete.md'],
  'time and sales': ['market-structure/market-structure-complete.md'],
  'tape reading': ['market-structure/market-structure-complete.md', 'investors/livermore-philosophy.md'],
