        ...
        {loading ? (
          ...
          <>
            ...
            <div style={{ background: '#fff', border: '1px solid #e4e4e7', borderRadius: '10px', padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <button
                onClick={() => {
                  localStorage.setItem('ic_pending_report', `Give me a full council analysis of ${data.symbol}`)
                  localStorage.setItem('ic_pending_report_name', `Council Analysis: ${data.symbol}`)
                  router.push('/app')
                }}
                style={{
